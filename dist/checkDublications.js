...
exports.checkDublications = void 0;
...
{ values: playerOneValues }) => {
    ...
    const playerOneSimularValues = lookForSimularities(playerOneValues).filter(({ value }) => {
        return value !== null;
    });
...
exports.checkDublications = checkDublications;
//Sneding each player's sorted hand to 'playerThreeOfAKind' to tag them with their
//status regarding hand dublications.
const rankPlayerHandByDublications = (data) => {
        ...
        data.map((allValues, lowIndex) => {
            ...
            if (topIndex !== lowIndex && valueToComper === allValues) {
                ...
                handSimularities.map(({ value }) => {
                    if (value !== null && value === valueToComper)
                        dublication = true;
                });
                !dublication && count++;
            }
...
module.exports.checkDublications = exports.checkDublications;
